...
class FormAssinantesJuridica extends Form {

    function FormAssinantesJuridica() {
        parent::Form("site_pessoa_juridica");
        $this->flags = "LOFIU";
    }

    function configFields() {
        $f = $this->newField("char", array("razaosocial", "Razão Social"));
        $f->is_static = true;
        $this->addField($f, "LOFIU");

        $f = $this->newField("char", array("nomefantasia", "Nome Fantasia"));
        $f->is_static = true;
        $this->addField($f, "LOFIU");

        $f = $this->newField("char", array("cnpj", "CNPJ"));
        $f->is_static = true;
        $this->addField($f, "FIU");

        $f = $this->newField("char", array("inscricaoestadual", "Inscrição Estadual"));
        $f->is_static = true;
        $this->addField($f, "FIU");

        $f = $this->newField("char", array("inscricaomunicipal", "Inscrição Municipal"));
        $f->is_static = true;
        $this->addField($f, "FIU");

        $f = $this->newField("char", array("ramoatividade", "Ramo Atividade"));
        $f->is_static = true;
        $this->addField($f, "FIU");

        $f = $this->newField("char", array("numerofiliais", "Número de Filiais"));
        $f->is_static = true;
        $this->addField($f, "FIU");
    ...
    public function onPosPost($tmp_flag) {
        ...
        $sql = "SELECT * FROM site_pessoa_juridica WHERE id = $id";
